...
These fixtures implement the data-driven testing pattern by
providing configurable, reusable test infrastructure components.
"""
...
def track_healing_events(request):
    ...
    # Store test name for context
    test_name = request.node.name

    yield

    # After test: check for healing events
...
def pytest_sessionfinish(session, exitstatus):
    ...
    if events:
        ...
        # Save healing events for report generation
